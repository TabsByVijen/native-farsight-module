...
var gameVersion = [0,0];
var offsetRepository = "https://api.github.com/repos/TabsByVijen/native-farsight-module/contents/offsets?ref=main";
...
function makeSnapshot() {
    ...
    let snapshot;
    try {
        snapshot = addon.makeSnapshot();
    } catch(e) {
        console.error("Error while making snapshot: \n" + e);
        return {
            gameTime: 0
        };
    }
